...
;				result := send_to_python_script("C:\cbn_gits\AHK\smart_search\smart_search_api.py",args)
			...
			else
			{
				...
				result := send_to_python_script_debug("C:\cbn_gits\AHK\smart_search\smart_search_api.py",args)
...
action_call:
	...
	; msgbox,%SubPat%
	iniread,skype_path,running_all_settings.ini,paths,skype_path

	run, "%skype_path%" "/callto:%SubPat%"
...
action_smart_action:
	...
	final_result := send_to_python_script_debug("C:\cbn_gits\AHK\smart_search\smart_search_api.py",args)
	;msgbox,%final_result%
	Gui, 1: Font,  cgreen 
	guicontrol,1: font ,action_term_selected
...
^+u:: ; search in results
	load_csv_to_listview(final_result)
	gosub,guiHeight
	filedelete,C:\cbn_gits\AHK\smart_search\search_in_result.txt
	fileappend,%final_result%,C:\cbn_gits\AHK\smart_search\search_in_result.txt
