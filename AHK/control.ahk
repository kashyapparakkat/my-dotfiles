...
fileread,all_settings, global_all_settings.ini
stringreplace,all_settings, all_settings, <username>,%A_UserName%,all


filedelete, running_all_settings.ini
fileappend , %all_settings%, running_all_settings.ini

;; Overriding settings based on PC
iniread,ini_All,global_%A_UserName%_settings.ini,paths
...
Loop, Parse, ini_All, `n,`r
{
	...
	if (field2 <>"")
	{
		stringreplace,field2, field2, <username>,%A_UserName%,all
		IniWrite, %field2%, running_all_settings.ini, paths, %field1%
	}
}

config =
(
exit all,cbn1,cbn ved2,demo ved3,disp_gui
,
,
,
exit_all_scripts,launch,launch,launch,disp_gui
,
,,
,
)
...
Gui,1:Add, button, x+10 yp w75 h48 gexit_all_scripts vBut_Exit_V_all, exit all
Gui,1:Add, button, x+5 yp w75 h48 gexit_all_scriptsF , force exit
