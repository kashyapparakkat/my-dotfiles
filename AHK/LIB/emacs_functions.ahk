...
{
	If WinActive("ahk_exe javaw.exe")  Or WinActive("ahk_exe emacs.exe") ; WinActive("ahk_exe eclipse.exe") OrOr WinActive("ahk_exe sublime_text.exe")  Or WinActive("ahk_exe firefox.exe")
		return true
	else
		return false
}
